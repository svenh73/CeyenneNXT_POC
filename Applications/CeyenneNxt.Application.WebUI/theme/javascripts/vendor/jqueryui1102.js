      ...
      drag: function(event, ui) {
        ...
        for (i = inst.snapElements.length - 1; i >= 0; i--) {
          ...
          if (o.snapMode !== "inner") {
            ...
            rs = Math.abs(r - x1) <= d;
            if (ts) {
              ui.position.top = inst._convertPositionTo("relative", { top: t - inst.helperProportions.height, left: 0 })
                .top -
                inst.margins.top;
            }
            if (bs) {
          ...
          if (o.snapMode !== "outer") {
            ...
            if (bs) {
              ui.position.top = inst._convertPositionTo("relative", { top: b - inst.helperProportions.height, left: 0 })
                .top -
                inst.margins.top;
            }
            if (ls) {
      ...
      _proportionallyResize: function() {
        ...
        for (i = 0; i < this._proportionallyResizeElements.length; i++) {
          ...
          if (!this.borderDif) {
            this.borderDif = [];
            borders = [
              prel.css("borderTopWidth"), prel.css("borderRightWidth"), prel.css("borderBottomWidth"), prel
              .css("borderLeftWidth")
            ];
            paddings = [
    ...
    _resetButton: function() {
      ...
      if (icons.primary || icons.secondary) {
        if (this.options.text) {
          buttonClasses
            .push("ui-button-text-icon" + (multipleIcons ? "s" : (icons.primary ? "-primary" : "-secondary")));
        }
