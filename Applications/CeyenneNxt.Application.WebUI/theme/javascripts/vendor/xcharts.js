...
(function() {
  ...
  (function() {
    ...
    w.reduce = w.foldl = w.inject = function(n, t, r, e) {
      ...
      .reject = function(n, t, r) { return w.filter(n, function(n, e, u) { return!t.call(r, n, e, u) }, r) }, w.every =
      w.all = function(n, t, e) {
        t || (t = w.identity);
        var u = !0;
        return null == n
          ? u
    ...
    w
        ...
        .countBy = function(n, t, r) { return k(n, t, r, function(n, t) { w.has(n, t) || (n[t] = 0), n[t]++ }) },
      w.sortedIndex = function(n, t, r, e) {
        ...
        .size = function(n) { return null == n ? 0 : n.length === +n.length ? n.length : w.keys(n).length }, w.first =
        w.head = w
        .take = function(n, t, r) { return null == n ? void 0 : null == t || r ? n[0] : o.call(n, 0, t) }, w.initial =
        function(n, t, r) { return o.call(n, 0, n.length - (null == t || r ? 1 : t)) }, w.last =
        function(n, t, r) {
    ...
    w.bind = function(n, t) {
        ...
        .extend = function(n) {
          return A(o.call(arguments, 1), function(t) { if (t) for (var r in t) n[r] = t[r] }),
            n
        },
      w.pick = function(n) {
    ...
    w.isEqual = function(n, t) { return S(n, t, [], []) }, w.isEmpty = function(n) {
        ...
        x || function(n) { return"[object Array]" == l.call(n) }, w.isObject = function(n) { return n === Object(n) },
      ...
      w
        ...
        function(n) { return w.isNumber(n) && n != +n }, w
        .isBoolean = function(n) { return n === !0 || n === !1 || "[object Boolean]" == l.call(n) }, w.isNull =
        function(n) { return null === n }, w
        .isUndefined = function(n) { return void 0 === n }, w
        .has = function(n, t) { return f.call(n, t) }, w
        .noConflict = function() { return n._ = t, this }, w
        .identity = function(n) { return n }, w.times = function(n, t, r) {
        for (var e = Array(n), u = 0; n > u; u++) e[u] = t.call(r, u);
        return e
      }, w.random = function(n, t) { return null == t && (t = n, n = 0), n + (0 | Math.random() * (t - n + 1)) };
    var T = { escape: { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "/": "&#x2F;" } };
    ...
    w.template = function(n, t, r) {
      ...
      n.replace(e,
        function(t, r, e, a, o) {
          return i += n
              .slice(u, o)
              .replace(D, function(n) { return"\\" + B[n] }), r &&
  ...
  function getInsertionPoint(zIndex) {
    return _.chain(_.range(zIndex, 10))
      .reverse()
      .map(function(z) { return'g[data-index="' + z + '"]' })
      .value()
      .join(", ")
  }
  ...
  _scales.time = function(data, axis, bounds, extents) {
    return d3.time.scale().domain(_.map(extents, function(d) { return new Date(d) })).range(bounds)
  };
  ...
  function _getExtents(options, data, xType, yType) {
    ...
    extents = { x: d3.extent(nData, function(d) { return d.x }), y: d3.extent(nData, function(d) { return d.y }) };
    _.each([xType, yType],
      function(type, i) {
  ...
  (function() {
    ...
    function postUpdateScale(self, scaleData, mainData, compData) {
      self.xScale2 = d3.scale.ordinal()
        ...
        .rangeRoundBands([0, self.xScale.rangeBand()], .08)
    }

    function enter(self, storage, className, data, callbacks) {
      var barGroups, bars, yZero = self.yZero;
      barGroups = self._g.selectAll(selector + className).data(data, function(d) { return d.className });
      barGroups.enter()
        ...
        .attr("transform", function(d, i) { return"translate(" + self.xScale2(i) + ",0)" });
      bars = barGroups.selectAll("rect").data(function(d) { return d.data }, function(d) { return d.x });
      bars.enter()
        .append("rect")
        .attr("width", 0)
        .attr("rx", 3)
        .attr("ry", 3)
        .attr("x", function(d) { return self.xScale(d.x) + self.xScale2.rangeBand() / 2 })
        .attr("height", function(d) { return Math.abs(yZero - self.yScale(d.y)) })
        .attr("y", function(d) { return d.y < 0 ? yZero : self.yScale(d.y) })
    ...
    function update(self, storage, timing) {
      ...
      storage.barGroups.attr("class", function(d, i) { return _visutils.colorClass(this, i) })
        .transition()
        .duration(timing)
        .style("opacity", 1)
        .attr("transform", function(d, i) { return"translate(" + self.xScale2(i) + ",0)" });
    ...
    function destroy(self, storage, timing) {
      ...
      storage.bars.transition()
        .duration(timing)
        .attr("width", 0)
        .attr("x", function(d) { return self.xScale(d.x) + band })
    }
  ...
  (function() {
    ...
    function enter(self, storage, className, data, callbacks) {
      ...
      container = self._g.selectAll(selector + className).data(data, function(d) { return d.className });
      container.enter()
        .insert("g", insertBefore)
        .attr("data-index", zIndex)
        .attr("class",
    ...
    function update(self, storage, timing) {
      storage.lineContainers.attr("class", function(d, i) { return _visutils.colorClass(this, i) });
  ...
  (function() {
    ...
    function enter(self, storage, className, data, callbacks) { line.enter(self, storage, className, data, callbacks) }

    function _accumulate_data(data) {
      function reduce(memo, num) { return memo + num.y }
  ...
  var emptyData = [[]],
    defaults = {
      ...
      unsupported: function(selector) { d3.select(selector).text("SVG is not supported on your browser") },
  ...
  _.defaults(xChart.prototype,
  {
    ...
    _drawAxes: function() {
      ...
      if (labels.length > self._width / 80) {
        ...
        d3.selectAll(labels).filter(function(d, i) { return i % (Math.ceil(labels.length / xTicks) + 1) }).remove()
      }
      yRules = d3.svg.axis()
        .scale(self.yScale)
        .ticks(yTicks)
    ...
    _updateScale: function() {
      var self = this,
        _unionData = function() { return _.union(self._mainData, self._compData) },
    ...
    _draw: function() {
      ...
      comp = _.chain(self._compData).groupBy(function(d) { return d.type });
      compKeys = comp.keys();
