  ...
  var iButton = function(input, options) {
    ...
    $input
      ...
      .after(
        ...
        options.classHandle +
        '"><div class="' +
        options.classHandleRight +
        '"><div class="' +
        options.classHandleMiddle +
        '" /></div></div>' +
        '<div class="' +
        options.classLabelOff +
        '"><span><label>' +
        options.labelOff +
        '</label></span></div>' +
        '<div class="' +
        options.classLabelOn +
        '"><span><label>' +
        options.labelOn +
        '</label></span></div>' +
        '<div class="' +
    ...
    $container.bind("mousedown.iButton touchstart.iButton",
      function(e) {
    ...
    if (options.enableDrag) {
      ...
      $(document)
        .bind("mousemove.iButton_" + id + " touchmove.iButton_" + id,
          function(e) {
