(function() {
  ...
  $(function() {
    ...
    $(".core-animate-bars .box-toolbar a")
      .click(function(e) {
        e.preventDefault();
        return $(this)
          .closest(".core-animate-bars")
          .find(".progress .tip")
          .each(function() {
            ...
            return $(this)
              ...
              .attr("data-original-title", percent)
              .css({
                width: percent
              });
          });
    ...
    return setInterval(function() {
        return $(".easy-pie-chart, .easy-pie-chart-percent")
          .each(function() {
            var val;
