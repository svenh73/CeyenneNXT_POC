...
((): void => {
    ...
    function config($httpProvider: ng.IHttpProvider, $routeProvider: ng.route.IRouteProvider, $authProvider): void {
    ...
    function run($location: ng.ILocationService, $rootScope: ng.IRootScopeService, $auth: any): void {
        $rootScope.$on('oidcauth:signInCalled', () => {
