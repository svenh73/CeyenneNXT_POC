  ...
  function(api, module) {
    ...
    RangeIterator.prototype = {
      ...
      detach: function(detachRange) {
        ...
        this.range = this._current = this._next = this
          ._first = this._last = this.sc = this.so = this.ec = this.eo = null;
      }
    };
  ...
  wysihtml5.quirks.insertLineBreakOnReturn = function(composer) {
    ...
    function keyDown(event) {
      ...
      var element = event.target,
        ...
        blockElement = dom
          .getParentElement(selectedNode, { nodeName: USE_NATIVE_LINE_BREAK_WHEN_CARET_INSIDE_TAGS }, 4);
      if (blockElement) {
...
(function(wysihtml5) {
  ...
  function _getApplier(tagName, className, classRegExp) {
    ...
    if (!htmlApplier[identifier]) {
      htmlApplier[identifier] = new wysihtml5.selection
        .HTMLApplier(_getTagNames(tagName), className, classRegExp, true);
    }
  ...
  wysihtml5.views.Composer.prototype.observe = function() {
    ...
    dom.observe(element,
      ...
      function(event) {
        ...
        if (target &&
          target.nodeName === "IMG" &&
          (keyCode === wysihtml5.BACKSPACE_KEY || keyCode === wysihtml5.DELETE_KEY)) { // 8 => backspace, 46 => delete
        ...
        if (dialogElement) {
          ...
          dialog.observe("cancel",
            function() {
              ...
              that.editor
                .fire("cancel:dialog", { command: command, dialogContainer: dialogElement, commandLink: link });
            });
        }
        return dialog;
      },
  ...
  var tpl = {
    ...
    "link": function(locale, options) {
      ...
      return "<li>" +
        ...
        locale.link.cancel +
        "</a>" +
        "<a href='#' class='btn btn-blue' data-dismiss='modal'>" +
        locale.link.insert +
        "</a>" +
        "</div>" +
        "</div>" +
